...
/*!
 * @brief Checks whether or not the SW0 button is pressed
 *
 * @returns true if pressed, false if not
 */
bool PUSH_BUTTONS_SW0Pressed(void);

/*!
 * @brief Checks whether or not the SW1 button is pressed
 *
 * @returns true if pressed, false if not
 */
bool PUSH_BUTTONS_SW1Pressed(void);

/*!
 * @brief Checks whether or not the SW2 button is pressed
 *
 * @returns true if pressed, false if not
 */
bool PUSH_BUTTONS_SW2Pressed(void);

/*!
 * @brief Checks whether or not the SW3 button is pressed
 *
 * @returns true if pressed, false if not
 */
bool PUSH_BUTTONS_SW3Pressed(void);
