...
status_t PUSH_BUTTONS_Init()
{
    ...
    input_dev_push_buttons_pin_config.interruptMode = kGPIO_NoIntmode;

    GPIO_PinInit(BOARD_BUTTON_SW0_GPIO, BOARD_BUTTON_SW0_GPIO_PIN, &input_dev_push_buttons_pin_config);
    ...
    GPIO_PortClearInterruptFlags(BOARD_BUTTON_SW0_GPIO, (1 << BOARD_BUTTON_SW0_GPIO_PIN));
...
bool PUSH_BUTTONS_SW0Pressed()
{
    return !GPIO_PinRead(BOARD_BUTTON_SW0_GPIO, BOARD_BUTTON_SW0_GPIO_PIN);
}

bool PUSH_BUTTONS_SW1Pressed()
{
    return !GPIO_PinRead(BOARD_BUTTON_SW1_GPIO, BOARD_BUTTON_SW1_PIN);
}

bool PUSH_BUTTONS_SW2Pressed()
{
    return !GPIO_PinRead(BOARD_BUTTON_SW2_GPIO, BOARD_BUTTON_SW2_PIN);
}

bool PUSH_BUTTONS_SW3Pressed()
{
    return !GPIO_PinRead(BOARD_BUTTON_SW3_GPIO, BOARD_BUTTON_SW3_PIN);
}
