...
void lv_animimg_set_exec_cb(lv_obj_t * obj, lv_anim_exec_xcb_t exec_cb, void* var)
{
    lv_animimg_t * animimg = (lv_animimg_t *)obj;
    animimg->exec_cb = exec_cb;
    animimg->exec_var = var;
}
...
static void index_change(lv_obj_t * obj, int32_t index)
{
    ...
    if (animimg->exec_cb)
    {
        ...
        animimg->exec_cb(animimg->exec_var, (100 * idx) /animimg->pic_count);
    }
}
