...
#define MQS_SAI       SAI3
#define MQS_SAI_CLOCK kCLOCK_Root_Sai3
/* Select Audio/Video PLL (393.24 MHz) as MQS clock source */
#define MQS_SAI_CLOCK_SOURCE_SELECT (kCLOCK_SAI3_ClockRoot_MuxAudioPllOut)
/* Clock divider for MQS clock source */
#define MQS_SAI_CLOCK_SOURCE_DIVIDER (6U)
/* Get frequency of MQS clock */
#define MQS_SAI_CLK_FREQ       CLOCK_GetRootClockFreq(MQS_SAI_CLOCK)
