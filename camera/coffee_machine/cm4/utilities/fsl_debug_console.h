...
#if (defined(__MULTICORE_M4SLAVE) || defined(__MULTICORE_MASTER))
#include "fsl_sema4.h"
#include "board.h"
#define DEBUG_CONSOLE_LOCK()   {SEMA4_Lock(BOARD_SEM4_BASE, BOARD_SEM4_UART_GATE, BOARD_SEM4_PROC_NUM);}
#define DEBUG_CONSOLE_UNLOCK() {SEMA4_Unlock(BOARD_SEM4_BASE, BOARD_SEM4_UART_GATE);}
#endif
