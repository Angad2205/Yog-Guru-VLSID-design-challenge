...
void lv_port_disp_init(void)
{
    ...
    fbInfo.pixelFormat = DEMO_BUFFER_PIXEL_FORMAT;
    fbInfo.width       = DISPLAY_DEV_Yoguru_WIDTH;
    fbInfo.height      = DISPLAY_DEV_Yoguru_HEIGHT;
    fbInfo.startX      = DISPLAY_DEV_Yoguru_StartX;
    fbInfo.startY = DEMO_BUFFER_HEIGHT - DISPLAY_DEV_Yoguru_HEIGHT - DISPLAY_DEV_Yoguru_StartY;
    fbInfo.strideBytes = DISPLAY_DEV_Yoguru_WIDTH * DISPLAY_DEV_Yoguru_BPP;
